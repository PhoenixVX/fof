...
public class DwellerBugEntity extends HostileEntity implements Monster, IAnimatable {
    ...
    public static final EntityType<DwellerBugEntity> TYPE = EntityType.Builder.create(DwellerBugEntity::new, SpawnGroup.MONSTER).setDimensions(2.0F, 2.0F).allowSpawningInside(Blocks.STONE).build("fof_dweller_bug");
