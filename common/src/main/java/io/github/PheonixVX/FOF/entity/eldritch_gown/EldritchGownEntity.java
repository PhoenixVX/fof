...
public class EldritchGownEntity extends HostileEntity implements Monster, IAnimatable {
    public static final EntityType<EldritchGownEntity> TYPE = EntityType.Builder.create(EldritchGownEntity::new, SpawnGroup.MONSTER).setDimensions(1.40F, 2.75F).build("fof_eldritch_gown");
