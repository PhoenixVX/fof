package io.github.PheonixVX.FOF.entity.goliath_wolf;
...
public class GoliathWolfEntity extends HorseBaseEntity implements Monster, IAnimatable, Saddleable {
    public static final EntityType<GoliathWolfEntity> TYPE = EntityType.Builder.create(GoliathWolfEntity::new, SpawnGroup.MONSTER).setDimensions(1.75F, 2.50F).build("fof_goliath_wolf");
